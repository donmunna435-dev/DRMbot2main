import os
from pyrogram import Client as AFK24754824rom pyrogram.enums import ChatMemberStatus, ChatMembersFilter
...
class Config(object):
    ...
    AUTH_USERS = os.environ.get('AUTH_USERS', '968292174').split(',')
